...
NDefines.NGame.GAME_SPEED_SECONDS = { 0.375, 0.175, 0.1, 0.03, 0.0 }
...
NDefines.NProduction.BASE_FACTORY_MAX_EFFICIENCY_FACTOR = 40 -- from 50
...
NDefines.NProduction.BASE_FACTORY_EFFICIENCY_GAIN = 0.7
NDefines.NProduction.LICENSE_EQUIPMENT_BASE_SPEED = -0.20
NDefines.NProduction.LICENSE_EQUIPMENT_TECH_SPEED_PER_YEAR = -0.025
NDefines.NProduction.LICENSE_EQUIPMENT_UPGRADE_XP_FACTOR = 1.5
...
NDefines.NNavy.ENEMY_AIR_SUPERIORITY_IMPACT = -0.50
...
NDefines.NNavy.CONVOY_EFFICIENCY_LOSS_MODIFIER = 1 -- from 1.25
NDefines.NNavy.CONVOY_EFFICIENCY_REGAIN_AFTER_DAYS = 3 -- from 7
NDefines.NNavy.CONVOY_EFFICIENCY_REGAIN_BASE_SPEED = 0.10 -- from 0.04
NDefines.NNavy.CONVOY_EFFICIENCY_MIN_VALUE = 0.10 -- from 0.05
...
NDefines.NAI.MAX_SCREEN_TASKFORCES_FOR_MINE_LAYING = 0.10 --from 0.15
