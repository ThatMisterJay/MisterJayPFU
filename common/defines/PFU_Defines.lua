...
NDefines.NMilitary.LEADER_SKILL_FACTOR = 1.0
...
NDefines.NAir.COMBAT_DAMAGE_SCALE = 0.4
...
NDefines.NNavy.COMBAT_ESCAPING_SPEED_BALANCE = 0.5
...
NDefines.NNavy.ENEMY_AIR_SUPERIORITY_IMPACT = -0.25
